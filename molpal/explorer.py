...
class Explorer:
    ...
    **kwargs
    ...
    def fit_model(self):
        ...
        # Scheduled fine-tuning surrogates (e.g. ft_molformer) update their
        # embedding matrices in-place.  Reset the flag so the next round
        # doesn't falsely signal a refresh.
        if getattr(self.model, "embeddings_refreshed", False):
            self.model.embeddings_refreshed = False
